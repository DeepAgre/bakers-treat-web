...
const BakeryApp = () => {
  ...
  return (
    <SmoothScroll>
      ...
      {/* TOP STRIP - Fixed Overlap by removing 'sticky' */}
      <div className="bg-[#1A1A1A] text-white text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.2em] py-3 text-center relative z-[110]">
      ...
      <div className="bg-[#F9F8F6] text-[#1A1A1A] font-sans selection:bg-[#E89EB8] selection:text-white">
        ...
        {/* Navbar now sits naturally below the strip */}
        <Navbar 
          cartCount={cartCount} 
