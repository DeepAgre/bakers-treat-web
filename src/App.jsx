...
const BakeryApp = () => {
  ...
  // UPDATED: Multi-Option Checkout Logic
  const handleCheckout = (type, deliveryDate) => {
    ...
    const headerMsg = type === 'whatsapp' ? "Hi Khushi! Query about:" : "NEW ORDER REQUEST";
    const footerMsg = type === 'whatsapp' 
      ? "Can we discuss this order?" 
      : "Please confirm availability. I will pay once you confirm!";
  ...
  return (
    <SmoothScroll>
      ...
      <main className={!isLoading ? "pt-32" : ""}>
        <div id="home"><Hero isParentLoading={isLoading} /></div>
        <CustomOrder />
        <div id="about">
          <Ingredients />
          <AboutKhushi /> 
