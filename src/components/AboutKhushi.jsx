      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          ...
          <div className="space-y-6 text-slate-600 font-sans leading-relaxed text-[16px] sm:text-lg">
            ...
            <p className="text-justify">
              Every creation at <strong className="text-slate-900 font-bold">Bakers Treat</strong> is a personal labor of love. By blending premium Belgian chocolate with seasonal artisanal fruits, Khushi ensures that her treats are as sophisticated in flavor as they are in appearance.
            </p>
          </div>
