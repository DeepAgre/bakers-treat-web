...
const AboutKhushi = () => {
  return (
    <section className="py-20 sm:py-32 px-6 max-w-7xl mx-auto overflow-hidden bg-white" id="about">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        >
          {/* We keep this card dark as a 'statement piece' accent - it looks very premium against the white section */}
          <div className="relative z-10 bg-[#1A1A1A] rounded-[2.5rem] sm:rounded-[3.5rem] p-10 sm:p-16 overflow-hidden shadow-2xl min-h-[450px] sm:min-h-[550px] flex flex-col justify-center border border-black/5">
          ...
          {/* Decorative Glow */}
          <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-[#E89EB8]/15 rounded-full blur-3xl -z-10" />
        </motion.div>
        ...
        >
          ...
          <div className="space-y-6 text-slate-600 font-sans leading-relaxed text-[16px] sm:text-lg">
            <p className="text-justify">
              Based in the heart of <span className="text-slate-900 font-semibold underline decoration-[#E89EB8]/40 underline-offset-4">Thane</span>, Khushi transformed her lifelong passion for art into a world of edible wonders. With a background in design and a perfectionist’s soul, she doesn't just bake—she crafts experiences.
            </p>
            <p className="text-justify">
              Every creation at <strong className="text-slate-900 font-bold">Delight Bakehouse</strong> is a personal labor of love. By blending premium Belgian chocolate with seasonal artisanal fruits, Khushi ensures that her treats are as sophisticated in flavor as they are in appearance.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 mt-12 pt-12 border-t border-slate-100">
            <div className="group">
              <p className="text-3xl sm:text-5xl font-serif font-bold text-slate-900 group-hover:text-[#E89EB8] transition-colors duration-300">100+</p>
