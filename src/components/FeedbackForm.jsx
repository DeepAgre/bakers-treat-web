      ...
      <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-xl border border-black/5 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <button 
              type="submit" 
              className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest text-xs transition-all ${status === 'loading' ? 'bg-gray-200 cursor-not-allowed' : 'bg-black text-white hover:bg-gray-800'}`}
