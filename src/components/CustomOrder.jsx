...
const CustomOrder = () => {
  ...
  const generateConcept = async () => {
    ...
    try {
      ...
      const imagePrompt = encodeURIComponent(
        `ultra luxury pastry chef cake, edible sculpture, high-end bakery photography, dramatic lighting, intricate frosting design, premium patisserie style, ${prompt}`
      );

      const imageUrl = `https://image.pollinations.ai/prompt/${imagePrompt}?width=1024&height=1280&seed=${Date.now()}&model=flux`;
  ...
  const handleConsultation = () => {
    const message = `Hi Khushi, I'm interested in a custom ${
      prompt || "bespoke"
    } cake from Delight Bakehouse! I loved the AI concept.`;
    window.open(
    ...
    <section className="py-24 relative overflow-hidden min-h-screen bg-[#080808] text-white font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-32 flex flex-col items-start max-w-5xl">
          ...
          >
            Collaborate with Chef Khushi Manjrekar to transform your vision
            into structural art.
          </motion.p>
          ...
          <div className="space-y-12">
            <div>
              ...
              <p className="text-white/40 text-lg leading-relaxed max-w-lg">
                Enter your theme to generate a custom cake flavor and conceptual
                design.
              </p>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/10 p-10 rounded-[3rem] space-y-8 backdrop-blur-sm">
              <input
                ...
                placeholder="Cyberpunk, Gothic Arch, Marble Flow..."
                value={prompt}
            ...
            <AnimatePresence>
              {aiPairing && (
                ...
                >
                  ...
                  <p className="text-white/40 italic">{aiPairing.reason}</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
            ...
            <div className="sticky top-10">
              <AnimatePresence mode="wait">
                {loading ? (
                  ...
                  <div className="aspect-[4/5] border border-dashed border-white/10 rounded-[3rem] flex items-center justify-center text-white/10">
