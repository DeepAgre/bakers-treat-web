...
const CustomOrder = () => {
  ...
  const generateConcept = async () => {
    ...
    try {
      ...
      // AI FLAVOR GENERATION (UNCHANGED)
      ...
      const imagePrompt = encodeURIComponent(
        `luxury architectural cake design, professional food photography, ${prompt}, edible art sculpture, hyper realistic, studio lighting, 8k`
      );

      const imageUrl = `https://image.pollinations.ai/prompt/${imagePrompt}?width=1024&height=1280&seed=${Date.now()}`;
    ...
    <section className="py-24 relative overflow-hidden min-h-screen bg-[#080808] text-white font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-32 flex flex-col items-start max-w-5xl">
          ...
          >
            Collaborate with Chef Khushi Manjrekar to transform your vision into structural art.
          </motion.p>
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <p className="text-white/40 text-lg leading-relaxed max-w-lg">
                Enter your theme to generate a custom cake flavor and conceptual design.
              </p>
            </div>
            ...
            <AnimatePresence>
              {aiPairing && (
                ...
                >
                  <div className="text-4xl font-serif mb-4">{aiPairing.combo}</div>
