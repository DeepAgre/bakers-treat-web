    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4">
        ...
        >
          ...
          <button 
            onClick={onClose}
            className="absolute top-4 right-4 z-[10001] bg-white p-2 rounded-full shadow-lg cursor-pointer hover:bg-gray-100"
          >
          ...
          <div className="w-full md:w-1/2 p-8 flex flex-col justify-between bg-white">
            <div>
              <span className="text-[#E89EB8] text-[10px] font-black uppercase tracking-widest mb-2 block font-sans">
                {product.category}
              </span>
            ...
            {/* Add to Bag Button - Added cursor-pointer */}
            <button 
              onClick={() => {
                onAddToBag(product);
                onClose();
              }}
              className="w-full bg-black text-white py-5 rounded-2xl font-black uppercase tracking-widest hover:bg-[#E89EB8] transition-all cursor-pointer shadow-lg active:scale-95"
            >
              Add to Bag
            </button>
          </div>
